...
public class HashNode<K,V> implements Map.Entry<K,V>{
     ...
     *
     * @param hash lower bound on initial capacity of the deque
	 * @param key lower bound on initial capacity of the deque
	 * @param value lower bound on initial capacity of the deque
	 * @param next lower bound on initial capacity of the deque
     */
