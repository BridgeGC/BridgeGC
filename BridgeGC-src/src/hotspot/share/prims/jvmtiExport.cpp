...
void JvmtiExport::initialize_oop_storage() {
  ...
  _jvmti_oop_storage = OopStorageSet::create_strong("JVMTI OopStorage", false, mtServiceability);
  _weak_tag_storage  = OopStorageSet::create_weak("JVMTI Tag Weak OopStorage", false, mtServiceability);
