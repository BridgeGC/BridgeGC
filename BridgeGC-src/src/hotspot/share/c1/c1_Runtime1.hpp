...
class Runtime1: public AllStatic {
 ...
 private:
  ...
  static void new_keep_instance    (JavaThread* current, Klass* klass);
  static void new_type_array  (JavaThread* current, Klass* klass, jint length);
  static void new_type_keep_array  (JavaThread* current, Klass* klass, jint length);
  static void new_object_array(JavaThread* current, Klass* klass, jint length);
  static void new_object_keep_array(JavaThread* current, Klass* klass, jint length);
