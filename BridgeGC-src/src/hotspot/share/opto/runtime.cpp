...
// object allocation
JRT_BLOCK_ENTRY(void, OptoRuntime::new_instance_C(Klass* klass, bool annotated, JavaThread* current))
  JRT_BLOCK;
#ifndef PRODUCT
...
// array allocation
JRT_BLOCK_ENTRY(void, OptoRuntime::new_array_C(Klass* array_type, bool annotated, int len, JavaThread* current))
  JRT_BLOCK;
#ifndef PRODUCT
...
JRT_BLOCK_ENTRY(void, OptoRuntime::new_array_nozero_C(Klass* array_type, bool annotated, int len, JavaThread* current))
  JRT_BLOCK;
#ifndef PRODUCT
  SharedRuntime::_new_array_ctr++;            // new array requires GC
#endif
