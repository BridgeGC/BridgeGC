...
public:
  ...
  static OopStorage* create_strong(const char* name, bool type, MEMFLAGS memflags);
  static OopStorage* create_weak(const char* name, bool type, MEMFLAGS memflags);
  static OopStorage* recreate_strong(const char* name, bool type, MEMFLAGS memflags);
