...
void StringDedup::Processor::initialize_storage() {
  ...
  _storages[0] = OopStorageSet::create_weak("StringDedup Requests0 Weak", false, mtStringDedup);
  _storages[1] = OopStorageSet::create_weak("StringDedup Requests1 Weak", false, mtStringDedup);
