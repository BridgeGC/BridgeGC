 ...
 *
 * @run main/othervm -XX:+UseBridgeGC compiler.loopopts.TestRangeCheckPredicatesControl
 * @run main/othervm -XX:+UseBridgeGC -XX:+UnlockDiagnosticVMOptions -XX:+StressGCM compiler.loopopts.TestRangeCheckPredicatesControl
 */
