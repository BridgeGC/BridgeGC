 ...
 * @summary Stress ZGC
 * @run main/othervm/timeout=200 -Xlog:gc*=info -Xmx384m -server -XX:+UseBridgeGC gc.stress.gcbasher.TestGCBasherWithZ 120000
 */
 ...
 * @run main/othervm/timeout=200 -Xlog:gc*=info,nmethod+barrier=trace -Xmx384m -server -XX:+UseBridgeGC
